...
<head>
    <base href="/">
        ...
        <meta name="description" content="Organic - Fruit & Vegetable Shop HTML Template">
                        ...
                        <div class="col-12">
                            ...
                            <div class="mobile-menu">
                                <nav class="menu-box">
                                    ...
                                    <div class="nav-logo">
                                        <a href="{{route('home.index')}}"><img src="assets/img/logo/logo.png" alt="Logo"></a>
                                    </div>
                                ...
                                <div class="footer-widget">
                                    ...
                                    <div class="footer-contact">
                                        <ul class="list-wrap">
                                            ...
                                            <li><a href="mailto:info@Organic.com">info@Organic.com</a></li>
                                        </ul>
                                    </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-7">
                                <div class="copyright-text">
                                    <p>© 2023 By <a href="index-2.html">Organic</a>, All Rights Reserved</p>
                                </div>
                            </div>
